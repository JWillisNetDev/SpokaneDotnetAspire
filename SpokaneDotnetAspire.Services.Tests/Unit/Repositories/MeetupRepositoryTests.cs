...
namespace SpokaneDotnetAspire.Api.Tests.Unit.Repositories;
...
public class MeetupRepositoryTests : UnitTestBase
{
    ...
    public async Task GetMeetupsAsync_ReturnsMeetups()
    {
        ...
        await InDbScopeAsync(async db =>
        {
            ...
            // Act
            actualMeetups = await repository.GetMeetupsAsync(0, 10);
        });
    ...
    public async Task CreateMeetup_CreatesNewMeetup()
    {
        ...
        const string expectedMeetupUrl = "https://example.com";
        Uri expectedImageUri = new("https://1.1.1.1/");
        ...
        await InDbScopeAsync(async db =>
        {
            ...
            // Act
            var result = await repository.CreateMeetupAsync(
                expectedTitle,
                expectedContent,
                expectedMeetupUrl,
                expectedImageUri);
        ...
        actualMeetup.MeetupUrl.Should().Be(expectedMeetupUrl);
        actualMeetup.ImageUri.Should().Be(expectedImageUri);
    }
    ...
    public async Task CreateMeetup_EmptyTitle_ReturnsErrorResult()
    {
        ...
        await InDbScopeAsync(async db =>
        {
            ...
            // Act
            var result = await repository.CreateMeetupAsync("", "Some content", null, null);
